...
{
    [TaskDescription("Synchronize a SharedFloat to/from a FsmFloat.")]
    ...
    public class SynchronizeFloat : Action
    {
        ...
        {
            if (isGlobalFsmVariable.Value) {
                var fsmVariable = FsmVariables.GlobalVariables.FindFsmFloat(FsmVariableName.Value);
                ...
                if (playMakerFSM != null) {
                    var fsmVariable = playMakerFSM.FsmVariables.FindFsmFloat(FsmVariableName.Value);
                    // The variable has to exist
                    if (fsmVariable != null) {
                        // Sync to Behavior Designer
                        if (toBehaviorDesigner.Value) {
