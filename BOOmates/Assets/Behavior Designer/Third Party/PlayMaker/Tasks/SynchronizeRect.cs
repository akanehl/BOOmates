...
{
    [TaskDescription("Synchronize a SharedRect to/from a FsmRect.")]
    ...
    public class SynchronizeRect : Action
    {
        ...
        {
            if (isGlobalFsmVariable.Value) {
                var fsmVariable = FsmVariables.GlobalVariables.FindFsmRect(FsmVariableName.Value);
                ...
                if (playMakerFSM != null) {
                    var fsmVariable = playMakerFSM.FsmVariables.FindFsmRect(FsmVariableName.Value);
                    // The variable has to exist
                    if (fsmVariable != null) {
                        // Sync to Behavior Designer
                        if (toBehaviorDesigner.Value) {
